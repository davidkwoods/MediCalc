...
namespace MediCalc.ViewModels
{
	public class MainViewModel : INotifyPropertyChanged
	{
		...
		public void LoadData()
		{
			...
			Items.Add(new ItemViewModel { LineOne = "A-a Gradient", LineTwo = "Predicts the degree of shunting in the lungs", Target = "/Pages/AaGradient.xaml", LineThree = "Habitant inceptos interdum lobortis nascetur pharetra placerat pulvinar sagittis senectus sociosqu suscipit torquent" });
			Items.Add(new ItemViewModel { LineOne = "BMI", LineTwo = "Body Mass Index", Target="/Pages/BMI.xaml", LineThree = "Ultrices vehicula volutpat maecenas praesent accumsan bibendum dictumst eleifend facilisi faucibus habitant inceptos" });
			Items.Add(new ItemViewModel { LineOne = "ABCD2", LineTwo = "Risk of Stroke", Target="/Pages/ABCD2.xaml", LineThree = "Maecenas praesent accumsan bibendum dictumst eleifend facilisi faucibus habitant inceptos interdum lobortis nascetur" });
